...
public class JwtUtil {
	...
	private String createToken(Map<String, Object> claims, String subject) {
		return Jwts.builder().setClaims(claims).setSubject(subject) // ilgili kullanıcı
				...
				.signWith(SignatureAlgorithm.HS256, SECRET_KEY) // kullanılan algoritma ve bu algoritma çalışırken
																// kullanılacak hash key değeri
				.compact();
	}

	// token hala geçerli mi? kullanıcı adı doğru ise ve token ın geçerlilik süresi
	// devam ediyorsa true döner.
